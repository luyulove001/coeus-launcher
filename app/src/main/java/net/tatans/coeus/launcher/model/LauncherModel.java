...
//		tdb.deleteAll(LauncherBean.class);
		if(al_launcher.size()!=15){
			...
			String[] names = {
					...
					Const.LAUNCHER_NAME_13,Const.LAUNCHER_NAME_14,Const.LAUNCHER_NAME_0,
			};
			String[] arr_sSort = {
					...
					Const.LAUNCHER_SORT_13,Const.LAUNCHER_SORT_14,Const.LAUNCHER_SORT_0,
			};
			int[] dIcon = {
					...
					Const.LAUNCHER_ICON_13,Const.LAUNCHER_ICON_14,Const.LAUNCHER_ICON_0,
			};
			String[] arr_sPackage = { 
					...
					Const.LAUNCHER_PACK_13,Const.LAUNCHER_PACK_14,Const.LAUNCHER_PACK_0,
			};
			String[] arr_sMainClass = { 
					...
					Const.LAUNCHER_MAINCLASS_13,Const.LAUNCHER_MAINCLASS_14,Const.LAUNCHER_MAINCLASS_0,
			};
			//tdb.deleteAll(LauncherBean.class);
