...
public class OneKeyKuFMBook implements onLauncherListener {
	...
	public void onLauncherPrevious() {
		TatansToast.showAndCancel("节目:921评书开讲。");
	}
	...
	public void startKuFm(){
		Uri uri = Uri.parse("fmapps://app.fm.com/main?page=program&programId=264885");
		Intent intent = new Intent(Intent.ACTION_VIEW,uri);
		try {
			mContext.startActivity(intent);
		} catch (Exception e) {
			TatansToast.showAndCancel("酷FM 还未安装。"+e.toString());
		}
	}
	@Override
